...
export function PractitionerAccountMenu({align = "left", direction = "up", variant = "full", triggerClassName = "",}: AccountMenuProps): ReactNode {
    ...
    const items: { label: string; icon: IconType; danger?: boolean, href: string }[] = [
        { label: "Profile", icon: User, href: PractitionerProfileController.index.url() },
