...
import ClientComplianceController from "@/actions/App/Http/Controllers/Users/ClientComplianceController";
import {ClientAccountMenu} from "@/components/Menu/ClientAccountMenu";
...
const NAV_SECTIONS: NavSection[] = [
    {
        label: "Overview",
        items: [
            { name: "Dashboard", icon: LayoutDashboard, href: ClientDashboardController.url(), },
            { name: "Meal history", icon: Calendar, href:  MealHistoryController.url()},
        ],
    },
    // {
    //     label: "Tools",
    //     items: [
    //         { name: "Compliance", icon: ChartSpline, href: ClientComplianceController.url()}
    //     ],
    // },
    {
        label: "Account",
        items: [
            ...
            { name: "Profile", icon: User, href: ClientProfileController.index.url() },
        ],
    },
];
...
export default function ClientPortalLayout({children}: {children : ReactNode }): ReactNode {
      ...
      `}</style>
            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-y-auto">
                ...
                <div className="flex items-center justify-between gap-3 border-b border-stone-200 bg-stone-50/90 px-4 py-3 backdrop-blur md:hidden">
                    ...
                    <ClientAccountMenu variant="compact" align="right" direction="down" />
                </div>
